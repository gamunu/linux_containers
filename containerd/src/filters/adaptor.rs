...
impl<F> Adaptor for AdapterFunc<F> where F: Fn(Vec<String>) -> (String, bool) {
...
impl<F> Deref for AdapterFunc<F> where F: Fn(Vec<String>) -> (String, bool) {
    type Target = F;
...
impl<F> DerefMut for AdapterFunc<F> where F: Fn(Vec<String>) -> (String, bool) {
